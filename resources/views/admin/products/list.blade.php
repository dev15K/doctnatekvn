                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex gap-2 justify-content-center">
                            ...
                            <button id="btnDelete" class="btn btn-sm btn-danger" type="button">Delete</button>
                            <div class="d-none">
                                <form method="POST" action="{{ route('admin.products.delete', $product->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button id="btnDeleteSubmit" class="btn btn-sm btn-danger" type="submit">Delete
                                    </button>
                                </form>
                            </div>
                        </div>
